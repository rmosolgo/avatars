...
Batman.View.store.set('/avatars/form', '<div data-view=\"AvatarsFormView\" class=\"avatar-container\"><div class=\"row\"><div class=\"col-sm-12\"><ul data-showif=\"avatar.errors.length\" class=\"list-unstyled alert alert-warning\"><li data-foreach-e=\"avatar.errors\" data-bind=\"e.fullMessage\"></li></ul></div></div><div class=\"row avatar-controls\"><div class=\"col-sm-4\"><div class=\"form-group\"><input type=\"text\" placeholder=\"Who is this?\" data-bind=\"avatar.name\" class=\"form-control\"/></div></div><div class=\"col-sm-4\"><div class=\"form-group\"><select data-bind=\"selectedComponentId\" class=\"form-control\"><option>Select a Component</option><option data-foreach-component=\"Component.all\" data-bind=\"component.name\" data-bind-value=\"component.id\"></option></select></div></div></div><div class=\"row features-row\"><h4>Your Features:</h4><ul class=\"list-unstyled list-features\"><li data-foreach-feature=\"avatar.features.sortedByDescending.index\"><a data-bind=\"feature.name\" data-event-click=\"activateFeature | withArguments feature\"></a><a data-event-click=\"removeFeature | withArguments feature\" class=\"text-danger pull-right\">&times;</a></li></ul></div><div class=\"row avatar-row\"><div class=\"col-sm-6\"><div class=\"well well-small\"><canvas id=\"new-avatar\" style=\"height:300px; width:300px; border: 1px solid black; cursor:pointer;\"></canvas></div><a data-event-click=\"downloadAvatar\" class=\"btn btn-primary\"><span class=\"icon-download-arrow\"></span>Download Avatar</a></div><div class=\"col-sm-6 feature-col\"><div class=\"row\"><h3><span>Active Feature&nbsp;</span><br/><small data-bind=\"currentItem.feature.name\"></small></h3><div style=\"height:189px;\" class=\"img-container\"><img style=\"max-height:100px\" data-bind-src=\"currentItem.feature.imageDataURI\"/></div></div><div class=\"row item-controls\"><div class=\"col-sm-3\"><a data-event-click=\"zoomIn\"><span class=\"icon-zoom-in\"></span></a></div><div class=\"col-sm-3\"><a data-event-click=\"zoomOut\"><span class=\"icon-zoom-out\"></span></a></div><div class=\"col-sm-3\"><a data-event-click=\"rotateLeft\"><span class=\"icon-rotate-left\"></span></a></div><div class=\"col-sm-3\"><a data-event-click=\"rotateRight\"><span class=\"icon-rotate-right\"></span></a></div><div class=\"item-btn-controls\"><div class=\"col-sm-6\"><a data-event-click=\"bringToFront\" class=\"btn btn-primary\">Bring to Front</a></div><div class=\"col-sm-6\"><a data-event-click=\"sendToBack\" class=\"btn btn-primary\">Send to Back</a></div><div class=\"col-sm-12\"><a data-event-click=\"executeAction | withArguments &quot;keyboardShortcuts&quot;\" class=\"btn btn-info\">Keyboard Shortcuts</a></div></div></div></div></div></div>');
